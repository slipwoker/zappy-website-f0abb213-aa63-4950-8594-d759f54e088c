    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Ori Dahan and Daniel Dahan משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'f0abb213-aa63-4950-8594-d759f54e088c',
                    name: data.name || '',
                    email: data.email || '',
